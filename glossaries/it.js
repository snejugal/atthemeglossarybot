module.exports = {
  windowbackgroundwhite: {
    ...
    link: "http://telegra.ph/Glossario-variabili-per-temi-di-Telegram-Backgrounds-10-09"
  },
  ...
  chatwallpaper: {
    ...
    text: "{{correctWriting}} imposta lo sfondo delle chat, che sia un'immagine o un colore. <b>Devi cambiare questa variabile</b> così che Telegram possa includere il tuo sfondo nel tuo tema. Cambiare lo sfondo da Impostazioni → Sfondo chat <b>non</b> lo includerà nel tuo tema. \n<b>Nota bene:</b> se imposti un immagine come sfondo, esso verrà compresso da Telegram ogni volta che esegui una modifica ad una qualsiasi variabile nell'editor in-app. Per questa ragione devi impostare la tua immagine di nuovo prima di condividere il tema.",
    image: {
  ...
  avatartext: {
    ...
    link: "http://telegra.ph/Glossario-variabili-per-temi-di-Telegram-10-09#Avatars"
  }
}